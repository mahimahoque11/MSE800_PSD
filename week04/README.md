...
## Requirements
- Python 3
- SQLite viewer or DB Browser for SQLite for database files
- Image viewer for PNG diagrams

## Notes
Each activity folder should include its own README explaining the task, files, run steps, and any requirements.
